...
function onSelectionChanged(context) {
  ...
  if (Object(sketch_module_web_view_remote__WEBPACK_IMPORTED_MODULE_2__["isWebviewPresent"])('unique.id')) {
    log('isWebviewPresent'); //win.show();
...
var convertUnit = function convertUnit(rect, settings) {
  ...
  switch (heightUnit) {
    ...
    case "rpx":
      style += "height:" + rect.height + "rpx;<br>";
      break;
...
var getTextStyle = function getTextStyle(text, settings) {
  ...
  var fontSizeUnit = settings.fontSize,
...
/*获取设置*/
 //引入sketch 的新API（新旧混用，心情复杂

function getSettings() {
  var Settings = sketch__WEBPACK_IMPORTED_MODULE_0___default.a.Settings; //引入sketch 的Settings API
