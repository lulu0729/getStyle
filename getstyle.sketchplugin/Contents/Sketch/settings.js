...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  var Settings = sketch__WEBPACK_IMPORTED_MODULE_1___default.a.Settings; //Settings API
  ...
  win.once('ready-to-show', function () {
    var settings = Object(_unit__WEBPACK_IMPORTED_MODULE_2__["getSettings"])(); //获取已设置的settings

    log("settings" + settings);

    for (var key in settings) {
      win.webContents.executeJavaScript("innerSettings('" + key + "','" + settings[key] + "')");
    }

    win.show();
  });
  win.webContents.on('nativeLog', function (key, value) {
    log('set key:' + key);
    log('set value:' + value);
